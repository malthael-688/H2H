...
<head>
  ...
  <link rel="stylesheet" id="skin_css" href="css2/skins/default.css">

  <!-- contains styles not supported by IE 6, 7, 8 -->
  <!--[if gt IE 8]><!-->
  <!-- css3 hover effects -->
  <link rel="stylesheet" media="screen" href="css2/effects/all.css">
  <!-- for screens 768px or less in width -->
  <link rel="stylesheet" type="text/css" media="screen" href="css2/responsive.css" />
  <!-- iPhone specific -->
  <link rel="stylesheet" type="text/css" media="screen and (min-device-width : 320px) and (max-device-width: 480px)" href="css2/mobile.css" />
  <!-- <![endif]-->

  <!-- printing rules -->
  <link rel="stylesheet" media="print" href="css2/print.css">

  <!-- Fancybox Plugin -->
  <link rel="stylesheet" href="js2/libs/fancybox/jquery.fancybox-1.3.4.css" type="text/css" media="screen">
  ...
  <script src="js2/libs/modernizr-2.0.6.min.js"></script>
      ...
      <article class="markup">
       ...
       <form id="information" class="contact-form" action="~~" method="post">
			  ...
			  <div class="item">
					...
					<img src="img/head.png" alt="publisher">
			  ...
			  <div class="item">
					<a href="" class="icon">
					<img src="img/reward.png" alt="rewardPoints">
			  ...
			  <div class="item">
					<a href="" class="icon">
					<img src="img/time.png" alt="taskTime">
		...
		<br>  			
            <div class="comments">
    			...
    			<div class="comment-wrap">
       			<div class="photo">
            	<div class="avatar" style="background-image: url('/img/4.jpg')"></div>
				</div>
			...
			<c:forEach items="${comments}" var="comment" varStatus="Co">
				...
				<label>${comment.name}</label>
 		    	...
 		    	<div class="comment-wrap">
        		<div class="photo">
            	<div class="avatar" style="background-image: url('/img/1.jpg')"></div>
        		</div>
       			<div class="comment-block">
...
<div id="resize">Resize</div>
  ...
  <!-- jQuery 1.6.2 -->
  <script src="js/jq1/jquery.min.js"></script>
  ...
  <script defer src="js/jq1/plugins.js"></script>
  <script defer src="js/jq1/script.js"></script>
