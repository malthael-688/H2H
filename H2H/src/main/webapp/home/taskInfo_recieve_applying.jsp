    ...
    <div class="modal-dialog" style = "position: relative; top:30%;">
		...
		<div class="indexMain_left_con" style="height: 150px;">
			...
			<div>
				...
				<a href="/home/ToOthers?num=${task.publisherNum }" style="position: relative; left: 40px; top: 46px;"><span class="myspan">${publisherName }</span></a>
			</div>
				<div>
                	...
                	<div class="indexCon_msg_detail">
						<a href="../otherPeople.jsp">
						 <div class="indexCon_msg_detail_tittle">
                            <p style="font-size: 17px;"><span class="glyphicon glyphicon-user" style="color: rgb(0, 152, 193);"></span> <a href="/home/ToOthers?num=${comment.commentatorNum }">评论人： ${comNames[Co.count-1]} <a href="/home/ToOthers?num=${comment.commentatorNum }"></p>
                        </div>
						</a>
