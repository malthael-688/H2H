                	...
                	<div class="indexCon_msg_detail">
						<a href="../otherPeople.jsp">
						 <div class="indexCon_msg_detail_tittle">
                            <p style="font-size: 17px;"><span class="glyphicon glyphicon-user" style="color: rgb(0, 152, 193);"></span>评论人： <a href="/home/ToOthers?num=${comment.commentatorNum }">${comNames[Co.count-1]}</a></p>
                        </div>
						</a>
