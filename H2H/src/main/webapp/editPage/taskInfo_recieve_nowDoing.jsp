	...
	<div class="indexMain" style = "width:55%;">
		<div class="indexMain_left_btn" style="height: 20%;">
			...
			<div style="width: 50%; position: relative; left: 40%; bottom: 50%;">
				<a class="btn btn-danger " data-toggle="modal" data-target="#myModal1" style="width: 100%;"><em>放弃任务</em></a>
				<a class="btn btn-success " data-toggle="modal" data-target="#myModal" style="width: 100%;"><em>提交任务</em></a>
				<a href="/editPage/recieve_nowDoing_page" class="btn btn-primary"  style="width: 100%;"><em>返回</em></a>
			</div>
			</div>
			</div>
		</div>
    ...
    <div class="modal-dialog" style = "position: relative; top:30%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">确认提交提示</h4>
            </div>
...
<div>
			...
			<div style="position: relative; top: 30px; ">
        		<form action="/editPage/recieve_nowDoing_submit?taskId=${task.taskID}" method="post">
