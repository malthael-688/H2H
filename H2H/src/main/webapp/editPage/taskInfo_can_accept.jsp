	...
	<div class="indexMain" style = "width:55%;">
		<div class="indexMain_left_btn" style="height: 80px;">
			...
			<div style="width: 50%; position: relative; left: 85%; bottom: 50%;">
				...
				<a href="/editPage/publish_examine_page" class="btn btn-primary"><em>返回</em></a>
			</div>
		</div>
		<!-- 模态框（Modal） -->
    ...
    <div class="modal-dialog" style = "position: relative; top:30%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick = "location.href='/editPage/acceptTask?taskId=${task.taskID}'">接受任务</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
