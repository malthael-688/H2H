	...
	<div class="indexMain" style = "width:55%;">
		<div class="indexMain_left_btn" style="height: 20%;">
			...
			<div style="width: 50%; position: relative; left: 40%; bottom: 50%;">
				<a class="btn btn-danger " data-toggle="modal" data-target="#myModal" style="width: 100%;"><em>取消任务</em></a>
				<a href="/editPage/publish_unaccept_page" class="btn btn-primary"  style="width: 100%;"><em>返回</em></a>
			</div>
			</div>
			</div>
		</div>
    ...
    <div class="modal-dialog" style = "position: relative; top:30%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">确认取消提示</h4>
            </div>
...
<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style = "position: relative; top:30%;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">确认放弃提示</h4>
            </div>
            <div class="modal-body">是否确认放弃该任务？注意这会造成一定的积分损失...</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" onclick = "#">放弃任务</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
		...
		<div class="indexMain_left_con" style="height: 200px;">
			...
			<div>
				...
				<br>
																<div style="float: right;">
				<label class="mylabel" style="position: relative; font-size: 18px;">任务状态: 未开始</label>
				</div>
			</div>
    	</div>
						<div class="indexMain_left_con" style="height: auto;">
							<br>
							<div>
					<p style = "font-size: 17px; ">申请人列表：</p>
						<c:forEach items="${applyList1}" var="applicant" varStatus="st"> 
							<hr>
							<ul class="list-inline">
                            <li><span class="glyphicon glyphicon-user" style="color: rgb(0, 152, 193);"></span><a href = "/editPage/ToOthers?num=${applicant.num}" style = "font-size: 17px; ">${applicant.name}:</a></li>
							<li></li>
							<li></li>
							<li></li><li></li>
							<li></li><li></li>
							...
							<li><a   href="/editPage/selectReceiver?taskID=${task.taskID}&num=${applicant.num}"   class="btn btn-success"  style="width: 100%;"><em>指派其为任务完成人</em></a> </li>
							<li></li><li></li>
                        </ul>
						</c:forEach>		
					</div>
			...
			<div style="position: relative; top: 30px; ">
        		<form action="/editPage/publish_unStart_submit?taskId=${task.taskID}" method="post">
