    ...
    <div class="modal-dialog" style = "position: relative; top:30%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick = "javascript:window.location.href='/editPage/quitApplying?taskId=${task.taskID}'">确认取消申请</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
		...
		<div class="indexMain_left_con" style="height: 200px;">
			...
			<div>
				...
				<br>
																<div style="float: right;">
				<label class="mylabel" style="position: relative; font-size: 18px;">任务状态: 申请中</label>
				</div>
			</div>
    	</div>
			...
			<div style="position: relative; top: 30px; ">
        		<form action="/editPage/recieve_applying_submit?taskId=${task.taskID}" method="post">
