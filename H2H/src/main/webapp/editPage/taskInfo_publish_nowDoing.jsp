	...
	<div class="indexMain" style = "width:55%;">
		<div class="indexMain_left_btn" style="height: 80px;">
			...
			<div style="width: 50%; position: relative; left: 40%; bottom: 50%;">
				<a class="btn btn-success " data-toggle="modal" data-target="#myModal" style="width: 100%;"><em>验收任务</em></a>
				<a href="/editPage/publish_nowDoing_page" class="btn btn-primary"  style="width: 100%;"><em>返回</em></a>
			</div>
			</div>
			</div>
		</div>
    ...
    <div class="modal-dialog" style = "position: relative; top:30%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">确认任务完成提示</h4>
            </div>
            <div class="modal-body">是否确认该任务已被完成并进行验收？</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" onclick = "javascript:window.location.href='/editPage/yanshouTask?taskId=${task.taskID}'">验收任务</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
		...
		<div class="indexMain_left_con" style="height: 150px;">
			...
			<div>
				...
				<a href="#" style="position: relative; left: 40px; top: 46px;"><span class="myspan">接受人:${receivername}</span></a>
			</div>
			<div>
				<span class="glyphicon glyphicon-usd" style="color: rgb(255, 235, 118); font-size: 25px; position: relative; left: 280px; top: 18px;"></span>
				<label class="mylabel" style="position: relative; left: 290px; top: 14px;">悬赏: ${task.rewardPoints}</label>
				<span class="glyphicon glyphicon-cog" style="color:gray; font-size: 25px; position: relative; left: 415px; top: 18px;"></span>
				<label class="mylabel" style="position: relative; left: 420px; top: 14px;">类型: ${task.type}</label>
				<br>

				<span class="glyphicon glyphicon-time" style="color:black; font-size: 25px; position: relative;left: 30px; top: 46px;x; top: 18px;"></span>
			...
			<div style="position: relative; top: 30px; ">
        		<form action="/editPage/publish_nowDoing_submit?taskId=${task.taskID}" method="post">
